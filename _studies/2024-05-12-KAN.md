...
<img src="images\캡처.JPG (1).jpg" width="400px" height="100px">
...
<img src="images\캡처.JPG (2).jpg" width="400px" height="500px">

- Query feature 와 랜덤 샘플링한 support feature 를 각각 Attention 의 query, key 값으로 넣어준다.
- Attention coefficent : $$A = \mathbf{Softmax} \left( \frac {{\bf(QW)}{\bf(SW)}^T}{\sqrt d} \right)$$, 
